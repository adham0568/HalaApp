        ...
        child: Column(
          children: [
                            ...
                            ElevatedButton(onPressed: () async {
                              ...
                              await addMainCollection.uploadMain_Collection(
                                imgPath: imgPath!,
                                  imgName: imgName!,
                                  IdCollection: widget
                                      .DataFromeCollectionPage['IdCollection'],
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance.collection('Collection').doc(widget.DataFromeCollectionPage['IdCollection']).collection('mainCollection').snapshots(),
